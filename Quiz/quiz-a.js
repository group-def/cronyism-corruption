...
const answerCards = [
    ...
    },
    {
        correct: {
            title: 'Correct!',
            content: "Although the logic behind this decision remains unclear, <a href='https://www.theguardian.com/politics/2020/oct/05/how-excel-may-have-caused-loss-of-16000-covid-tests-in-england' target='_blank'>the Government opted to use Microsoft Excel to store results from Covid-19 tests</a>. Although Excel is not inherently problematic, issues arose due to the use of an old file format. Developers used a format (XLS) which dates back to 1987 and can only store 65,000 rows of data, compared to the newer format (XLSX) which can store over one million. This ultimately resulted in the loss of around 15,000 cases over an eight-day period - with almost 2,000 cases missed each day. <a href='https://www.bbc.co.uk/news/technology-54423988' target='_blank'>This costly mistake left experts baffled, with Professor John Crowcroft of the University of Cambridge claiming the government should have opted for a bespoke solution, as 'nobody would start with [XLS]'.</a>"
        },
        incorrect: {
            title: `Incorrect! The correct answer is D!`,
            content: "Although the logic behind this decision remains unclear, <a href='https://www.theguardian.com/politics/2020/oct/05/how-excel-may-have-caused-loss-of-16000-covid-tests-in-england' target='_blank'>the Government opted to use Microsoft Excel to store results from Covid-19 tests</a>. Although Excel is not inherently problematic, issues arose due to the use of an old file format. Developers used a format (XLS) which dates back to 1987 and can only store 65,000 rows of data, compared to the newer format (XLSX) which can store over one million. This ultimately resulted in the loss of around 15,000 cases over an eight-day period - with almost 2,000 cases missed each day. <a href='https://www.bbc.co.uk/news/technology-54423988' target='_blank'>This costly mistake left experts baffled, with Professor John Crowcroft of the University of Cambridge claiming the government should have opted for a bespoke solution, as 'nobody would start with [XLS]'.</a>"

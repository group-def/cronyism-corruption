...
const answerCards = [
    {
        correct: {
            title: 'Correct!',
            content: 'In April 2020, <a href="https://www.theguardian.com/world/2020/may/07/all-400000-gowns-flown-from-turkey-for-nhs-fail-uk-standards">the UK government ordered a shipment of 400,000 gowns from a Turkish T-Shirt manufacturer</a> in order to deal with the huge demand for Personal Protective Equipment for NHS staff. <a href="https://www.theguardian.com/world/2020/may/07/all-400000-gowns-flown-from-turkey-for-nhs-fail-uk-standards">Unfortunately, the gowns failed to meet UK standards and had to be returned to the supplier</a>, leaving vulnerable NHS staff still desperately short of PPE.'
        },
        incorrect: {
    ...
    },
    {
        correct: {
            title: 'Correct!',
            content: "<a href='https://www.theverge.com/2020/5/5/21248288/uk-covid-19-contact-tracing-app-bluetooth-restrictions-apple-google'>Rather than using the widely-adopted Apple and Google model</a>, or adapting the existing NHS system, the UK government decided to develop their own contact-tracing app. The government then appointed <a href='https://www.bristolpost.co.uk/news/local-news/dido-harding-track-trace-app-4170387'>Baroness Dido Harding</a> - a Tory peer and wife of Tory MP, John Penrose, who is best known for being the CEO of TalkTalk, where, in 2015, she presided over a data breach which lead to the loss of the financial and personal information of over 150,000 customers - to lead development of the app, despite her lack of experience in the public health sector. Inevitably, following numerous delays to the app's release and countless other mishaps, <a href='https://www.theguardian.com/world/2020/jun/18/uk-poised-to-abandon-coronavirus-app-in-favour-of-apple-and-google-models'>the government abandoned their 'world-beating' app and decided to instead use the Google and Apple model.</a>"
        },
        incorrect: {
            title: `Incorrect! The correct answer is B!`,
            content: "<a href='https://www.theverge.com/2020/5/5/21248288/uk-covid-19-contact-tracing-app-bluetooth-restrictions-apple-google'>Rather than using the widely-adopted Apple and Google model</a>, or adapting the NHS existing system, the UK government decided to develop their own contact-tracing app. The government then appointed <a href='https://www.bristolpost.co.uk/news/local-news/dido-harding-track-trace-app-4170387'>Baroness Dido Harding</a> - a Tory peer and wife of Tory MP, John Penrose, who is best known for being the CEO of TalkTalk, where, in 2015, she presided over a data breach which lead to the loss of the financial and personal information of over 150,000 customers - to lead development of the app, despite her lack of experience in public health. Inevitably, following numerous delays to the app's release and countless other mishaps, <a href='https://www.theguardian.com/world/2020/jun/18/uk-poised-to-abandon-coronavirus-app-in-favour-of-apple-and-google-models'>the government abandoned their 'world-beating' app and decided to instead use the Google and Apple model.</a>"
        }
    },
    {
        correct: {
            title: 'Correct!',
            content: "Although the logic behind this decision remains unclear, <a href='https://www.theguardian.com/politics/2020/oct/05/how-excel-may-have-caused-loss-of-16000-covid-tests-in-england'>the Government opted to use Microsoft Excel to store results from COVID-19 tests</a>, which had been analysed by commercial firms. Although the use of Excel is not inherently problematic, issues arose due to the use of an old file format - developers used the XLS format which dates back to 1987, rather than the newer XLSX format - which can only store 65,000 rows of data, compared to the newer format which can store over 1 million. This ultimately resulted in the loss of around 15,000 cases over the 8 day period in which the events took place - with almost 2,000 cases being missed each day. <a href='https://www.bbc.co.uk/news/technology-54423988'>This costly mistake left experts baffled, with Professor John Crowcroft of the University of Cambridge claiming the government should have opted for a bespoke solution, as 'nobody would start with [XLS]'.</a>"
        },
        incorrect: {
            title: `Incorrect! The correct answer is D!`,
            content: "Although the logic behind this decision remains unclear, <a href='https://www.theguardian.com/politics/2020/oct/05/how-excel-may-have-caused-loss-of-16000-covid-tests-in-england'>the Government opted to use Microsoft Excel to store the results from COVID-19 tests</a>, which had been analysed by commercial firms. Although the use of Excel is not inherently problematic, issues arose due to the use of an old file format - developers used the XLS format which dates back to 1987, rather than the newer XLSX format - which can only store 65,000 rows of data, compared to the newer format which can store over 1 million. This ultimately resulted in the loss of around 15,000 cases over the 8 day period in which the events took place - with almost 2,000 cases being missed each day. <a href='https://www.bbc.co.uk/news/technology-54423988'>This costly mistake left experts baffled, with Professor John Crowcroft of the University of Cambridge claiming the government should have opted for a bespoke solution, as 'nobody would start with [XLS]'.</a>"
        }
    },
    {
        correct: {
            title: 'Correct!',
            content: "<a href='https://cdn-prod.opendemocracy.net/media/documents/Palantir_Agreements.pdf'>According to a contract posted online</a>, <a href='https://www.cnbc.com/2020/06/08/palantir-nhs-covid-19-data.html'>the UK government gave American spy-tech firm, Palantir, access to sensitive medical records of COVID-19 patients</a> including information on their health conditions, treatments and medicines, X-ray results, test results, and whether a person smokes or drinks. According to Open Democracy, Palantir were granted intellectual property rights and ‘and were allowed to train their models and profit off their unprecedented access to NHS data’. The exact details of the deal and the uses of the data are, however, still shrouded in mystery, with the UK government only publishing details of the agreement after several Freedom of Information requests and <a href='https://www.opendemocracy.net/en/ournhs/why-were-suing-over-the-23m-nhs-data-deal-with-palantir/'>the threat of legal action from Open Democracy and Foxglove.</a>"
        },
        incorrect: {
    ...
    },
    {
        correct: {
            title: 'Correct!',
            content: "Rather than going through a competitive tender process - where companies bid for the rights to contracts - <a href='https://www.nao.org.uk/report/government-procurement-during-the-covid-19-pandemic/'>a report by the National Audit Office</a> found that the British government prioritised companies with political connections when allocating contracts throughout the pandemic. Reportedly, <a href='https://www.bbc.co.uk/news/business-54978460'>the government established a 'high-priority lane' for companies who were referred by government officials and ministers</a>, <a href='https://www.nao.org.uk/report/government-procurement-during-the-covid-19-pandemic/'>with suppliers in this lane being roughly ten times more likely to obtain contracts than those processed through ordinary channels</a>. <a href='https://www.nao.org.uk/press-release/investigation-into-government-procurement-during-the-covid-19-pandemic/'>Of the £17.3 billion worth of contracts which were awarded, 60% of these contracts were awarded without a competitive process</a>, which has ultimately lead to contracts being granted to companies with little suitability to the task. <a href='https://www.bmj.com/content/371/bmj.m4489'>Most notably, US jewellery company, Saiger, was granted £250 million worth of PPE contracts despite having no experience in supplying in PPE, which resulted in the Department for Health and Social Care overpaying by almost £2.50 per gown</a>. <a href='https://www.bmj.com/content/371/bmj.m4489'>According to the Good Law Project, the government received over 24,000 offers from 16,000 suppliers, many of whom had experience in providing PPE, yet three of the biggest beneficiaries of government contracts were companies specialising in jewellery (Saiger), pest control (Pestfix), and an opaque 'family office' owned through a tax haven (Ayanda).</a>"
        },
        incorrect: {
            title: `Incorrect! The correct answer is B!`,
            content: "Rather than going through a competitive tender process - where companies bid for the rights to contracts - <a href='https://www.nao.org.uk/report/government-procurement-during-the-covid-19-pandemic/'>a report by the National Audit Office</a> found that the British government prioritised companies with political connections when allocating contracts. Reportedly, <a href='https://www.bbc.co.uk/news/business-54978460'>the government established a 'high-priority lane' for companies who were referred by government officials and ministers</a>, <a href='https://www.nao.org.uk/report/government-procurement-during-the-covid-19-pandemic/'>with suppliers in this lane being roughly ten times more likely to obtain contracts than those processed through ordinary channels</a>. <a href='https://www.nao.org.uk/press-release/investigation-into-government-procurement-during-the-covid-19-pandemic/'>Of the £17.3 billion worth of contracts which were awarded, 60% of these contracts were awarded without a competitive process</a>, which has ultimately lead to contracts being granted to companies with little suitability to the task. <a href='https://www.bmj.com/content/371/bmj.m4489'>Most notably, US jewellery company, Saiger, was granted £250 million worth of PPE contracts despite having no experience in supplying in PPE, which resulted in the Department for Health and Social Care overpaying by almost £2.50 per gown. According to the Good Law Project, the government received over 24,000 offers from 16,000 suppliers, many of whom had experience in providing PPE, yet three of the biggest beneficiaries of government contracts were companies specialising in jewellery (Saiger), pest control (Pestfix), and an opaque 'family office' owned through a tax haven (Ayanda).</a>"
        }
    },
    {
        correct: {
            title: 'Correct!',
            content: "While some of the UK’s most vulnerable children went hungry due to COVID-19, <a href='https://www.dw.com/en/food-parcels-for-kids-spark-outrage-in-uk/a-56217308'>the UK government replaced their existing voucher scheme - which gave vulnerable families £15 per week per child while schools were closed - with food parcels intended to last the whole week</a>. Although the food packages were supposed to last 10 days and contain food worth around £30, <a href='https://www.dw.com/en/food-parcels-for-kids-spark-outrage-in-uk/a-56217308'>in reality the produce in the packages was sparse and lacking in nutritional value</a>, <a href='https://www.newstatesman.com/politics/uk/2020/10/208m-food-box-rip-off-private-outsource-government-contract-covid-corona-virus'>with the actual value of each parcel coming in at less than £10</a>. The government paid £208 million to private firm, Chartwells, to carry out the scheme, with over 4.7 million boxes being distributed in England alone. Despite the government not revealing the cost of each individual box, based on the total cost of the scheme and the total number of boxes delivered, <a href='https://www.newstatesman.com/politics/uk/2020/10/208m-food-box-rip-off-private-outsource-government-contract-covid-corona-virus'>the New Statesman have estimated that each box cost the taxpayer over £44</a>, despite their underwhelming contents."
        },
        incorrect: {
